...
class CondicionController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('condiciones.index',compact('tipos_equipos','condiciones'));
    }
    ...
    public function create()
    {
        ...
        return view('condiciones.create',compact('tipos_equipos'));
    }
    ...
    public function edit($id)
    {
        ...
        $tipos_equipos = TipoEquipo::orderBy('nombre', 'asc')->lists('nombre','id');
        return view('condiciones.edit',compact('condicion',$condicion),compact('tipos_equipos',$tipos_equipos));
    }
