                ...
                <table>
                    ...
                    <tbody class="tbody4">
                        ...
                        <tr class="pesometro">
                            ...
                            <th><input type="text" class="form-control input v_unitario4" name="v_unitario4[]" style="width: 100px; text-align: center;" value="{{$pes->unitario}}"></th>
                            <td><input type="text" class="form-control input subtotal4" name="subtotal4[]" id="subtotal4" style="width: 100px; text-align: center;" disabled value="{{$pes->subtotal}}"></td>
                    ...
                    <tfoot>
                        <tr>
                            ...
                            <th></th>
                            <th><b>TOTAL</b></th>
                            <th><input type="text" class="totalpe" name="total4[]" style="width: 100px; text-align: center" disabled value="0.00"></th>
                        </tr>
                    </tfoot>
                </table>
                @endif
