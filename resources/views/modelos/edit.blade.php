        ...
        <div class="row">
            <div class="col-md-6 col-md-offset-3">
                ...
                {!!Form::model($modelo,['route' => ['modelo.update',$modelo -> id],'method' => 'PUT'])!!}
                    @include('modelos.formularios.modelo')
                    <button type="button" class=".btn btn-danger btn-flat col-md-offset-2"><a href="{!! URL::to('/modelo') !!}" style="color: #ffffff">Atrás</a></button>
