@extends('...administrador.index')
    @section('contenido')
        <div class="box-header">
            <h3 class="box-title">Lista de solicitudes finalizadas F-37</h3>
            <br><br>
        </div>
                ...
                <?php
                 ...
                 //obs:el 5 dias no lo pusiste vo, pero seria lo mismo que el 3
                     ...
                     echo "<td style='background-color: #ff0000;'></td>";
                             ...
                             ?>
                <td>{!!link_to_route('finalizado.edit',$title ='Editar',$parameters = $f37->numero,$attributes = ['class' => 'btn  btn-default btn-xs'])!!}</td>
            </tr>
        ...
        <h5>Color Rojo:Han transcurrido más de tres días desde que se enviaron loa datos</h5>
        @else
