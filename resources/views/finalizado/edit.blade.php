@extends('...administrador.index')
    ...
    <div class="box-header with-border">
        ...
        {!!Form::model($f37,['route' => ['finalizado.update',$f37 -> numero],'method' => 'PUT','id' => 'myForm'])!!}
        <div class="row">
            <div class="col-md-4">
            ...
            <div class="col-md-4">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control input" id="nombre_contacto" name="nombre_contacto" value="<?= $f37->nombre_contacto; ?>" style="width: 200px;" disabled>
                </div>
                <div class="form-group">
                    <label for="fono_contacto" class="col-xs-4 control-label">Fono Contacto:</label>
                    <input type="text" class="form-control input" id="fono_contacto" name="fono_contacto" value="<?= $f37->fono_contacto; ?>" style="width: 200px;" disabled>
                </div>
                <div class="form-group">
                    <label for="correo_contacto" class="col-xs-4 control-label">Correo Contacto:</label>
                    <input type="text" class="form-control input" id="correo_contacto" name="correo_contacto" value="<?= $f37->correo_contacto; ?>" style="width: 200px;" disabled>
                </div>
                <div class="form-group">
                    <label for="direccion_cliente" class="col-xs-4 control-label">Dirección Cli:</label>
                    <input type="text" class="form-control input" id="direccion_cliente" name="direccion_cliente" value="<?= $f37->direccion_cliente; ?>" style="width: 200px;" disabled>
                </div>
                <div class="form-group">
                    <label for="direccion_envio" class="col-xs-4 control-label">Dirección Envío:</label>
                    <input type="text" class="form-control input" id="direccion_envio" name="direccion_envio" value="<?= $f37->direccion_envio; ?>" style="width: 200px;" disabled>
                </div>
            </div>
            <div class="col-md-4">
                <div class="form-group">
                    <label for="ciudad_envio" class="col-xs-4 control-label">Ciudad Envío:</label>
                    <input type="text" class="form-control input" id="ciudad_envio" name="ciudad_envio" value="<?= $f37->ciudad_envio; ?>" style="width: 200px;" disabled>
                </div>
                <div class="form-group">
                    <label for="ciudad_envio" class="col-xs-4 control-label">Dirección des:</label>
                    <input type="text" class="form-control input" id="direccion_despacho" name="direccion_despacho" value="<?= $f37->direccion_despacho; ?>" style="width: 200px;" disabled>
                </div>
                <div class="form-group">
                    <label for="nota_venta" class="col-xs-4 control-label">Nota Venta:</label>
                    <input type="text" class="form-control input" id="nota_venta" name="nota_venta" value="<?= $f37->nota_venta; ?>" style="width: 200px;" disabled>
                </div>
                <div class="form-group">
                    <label for="orden_compra" class="col-xs-4 control-label">Orden Compra:</label>
                    <input type="text" class="form-control input" id="orden_compra" name="orden_compra" value="<?= $f37->orden_compra; ?>" style="width: 200px;" disabled>
                </div>
            </div>
        </div>
        <div class="row">
                    ...
                    <tbody id="tbody">
                        ...
                        <tfoot>
                            <tr>
                                ...
                                <th></th>
                                <th><b>TOTAL</b></th>
                                <th><input type="text" class="totalb" name="total[]" style="width: 100px; text-align: center" disabled value="{{ $bas->total }}"></th>
                            </tr>
                        </tfoot>
                    </table>
                    @endif
        ...
        <div class="row">
                ...
                <table>
                    ...
                    <tfoot>
                        <tr>
                            ...
                            <th></th>
                            <th><b>TOTAL</b></th>
                            <th><input type="text" id="totalp" name="total[]" style="width: 100px; text-align: center" disabled value="{{ $pes->total }}"></th>
                        </tr>
                    </tfoot>
                </table>
                @endif
                        ...
                        <table>
                            <tbody id="tbody5">
                                <tr id="miTablaPersonalizada">
                                    ...
                                    <th style="background-color: #E0F53F"><input type="text" class="form-control input nfactura" id="nfactura" name="nfactura" style="width: 100px; text-align: center" disabled value="<?= $codigof?>"></th>
                                    <th style="background-color: #E0F53F; width:140px;">Monto Neto</th>
                                    <th style="background-color: #E0F53F"><input type="number" class="form-control input monto_neto" id="monto_neto" name="monto_neto" style="width: 100px;" value="<?= $f37->monto_neto?>"></th>
                                    <th style="width:140px; background-color: transparent;"></th>
                                </tr>
                                <tr id="miTablaPersonalizada">

                                    <th style="background-color: #5D77E1; text-align: center"><input type="number" class="form-control input vtcotizado" id="vtcotizado" name="vt_cotizado" style="width: 100px;" value="<?= $f37->vt_cotizado ?>"></th>

                                    <th style="background-color: #5D77E1; width:140px;">Valor total cotizado</th>
                                    <th style="background-color: #5D77E1; width:140px;">IVA Actual</th>
                                    <th style="background-color: #5D77E1"><input type="number" class="form-control input monto_neto2" id="monto_neto2" name="monto_neto2" style="width: 100px;"  value="<?= 0.19; ?>"></th>
                                </tr>
                                <tr id="miTablaPersonalizada">
                                    <th style="width:140px; background-color: transparent;" ></th>
                                    <th style="width:140px; background-color: transparent;"></th>
                                    <th style="background-color: #E0F53F; width:140px;">Diferencia</th>
                                    <th style="background-color: #E0F53F"><input type="number" class="form-control input diferencia" id="diferencia" name="diferencia" style="width: 100px;" value="<?= $f37->diferencia ?>"></th>
                                </tr>
                            </tbody>
                        </table>
                    </div>
            ...
            <button type="button" class=".btn btn-danger btn-flat col-md-offset-6"><a href="{!! URL::to('/finalizado') !!}" style="color: #ffffff">Atrás</a></button>
