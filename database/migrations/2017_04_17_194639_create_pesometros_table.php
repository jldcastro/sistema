...
class CreatePesometrosTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('pesometros', function (Blueprint $table) {
            ...
            $table->string('ubicacion4');
            $table->integer('capacidad4');
            $table->integer('unidadc4_id')->unsigned()->nullable();
            $table->foreign('unidadc4_id')->references('id')->on('unidades')->onDelete('cascade');
            $table->integer('graduacion4');
            $table->integer('unidadg4_id')->unsigned()->nullable();
            $table->foreign('unidadg4_id')->references('id')->on('unidades')->onDelete('cascade');
